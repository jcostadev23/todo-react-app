...
export function PremiumTodos (){
    ...
    return (
        <div className='card'>
            ...
            <div className='listTodos'>Completed ( {filterTodos(listTodos).length} )</div>
                <div className='listTodos'> {filterTodos(listTodos).length !== 0 ? <ShowTodosDone d={showTodosDone ? "M3 4.5h14.25M3 9h9.75M3 13.5h5.25m5.25-.75L17.25 9m0 0L21 12.75M17.25 9v12" :
